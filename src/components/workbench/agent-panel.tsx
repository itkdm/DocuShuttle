...
import type { BrowserImageCandidate } from "@/modules/agent/browser-runtime";
...
export function AgentPanel({ stage, proposal, onCollapse, onRun, onCancel, onRetry, onDecide, mode, proposalSummary, awaitingFinalReview, onFinalReview, imageCandidates = [], imageTargetNodeId, imagePrompt, onImageTargetNodeIdChange, onImagePromptChange, onGenerateImages, onApplyImage, imageBusy }: AgentPanelProps) {
