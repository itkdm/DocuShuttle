...
export function AgentPanel({ stage, proposal, onCollapse, onRun, onCancel, onRetry, onDecide, mode, proposalSummary, awaitingFinalReview, onFinalReview, imageCandidates = [], imageTargetNodeId, imageNodes = [], imagePrompt, onImageTargetNodeIdChange, onImagePromptChange, onGenerateImages, onApplyImage, imageBusy }: AgentPanelProps) {
