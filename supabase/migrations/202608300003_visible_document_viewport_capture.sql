-- Visible viewport captures do not claim a Word page number.
-- This forward migration keeps 001/002 immutable while relaxing only the
-- provenance check for the currently supported target=visible tool.
